          ...
          {services.map((service, index) => {
            ...
            return (
              <motion.div
                ...
                className="group relative p-8 rounded-2xl border border-slate-200 bg-white/80 backdrop-blur-sm hover:border-primary-500/50 transition-all duration-500 text-center md:text-left"
                whileHover={{ y: -10, scale: 1.02 }}
              >
                <motion.div
                  className="w-16 h-16 mb-6 rounded-xl bg-primary-500/20 flex items-center justify-center border border-primary-500/30 group-hover:border-primary-500/50 transition-all mx-auto md:mx-0"
