...
export const SEO_SNIPPETS = {
  home: {
    ...
    metaKeywords: 'tech solutions UK, digital agency London, web development, mobile apps, strategic consulting, Tevuna, insight-driven solutions, digital strategy, software development, e-commerce development, React development, Next.js, Node.js, cloud solutions, DevOps, UI UX design, data analytics, business intelligence, API development, responsive web design, digital transformation, tech consultancy, software agency, London tech company, UK digital agency, app development, full-stack development, AI integration, machine learning solutions, custom software, web design London, mobile app development UK, Flutter development, TypeScript, database design, AWS Azure GCP, Kubernetes, Docker, CI/CD, agile development, MVP development, startup tech partner, enterprise solutions, SaaS development, Laravel PHP, WordPress development, Shopify development, Progressive Web Apps, system integration, automation solutions',
  ...
  academy: {
    ...
    metaKeywords: 'Tevuna Academy, tech courses UK, online programming courses, web development course, coding bootcamp, data analytics training, AI learning, tech education, learn to code, JavaScript course, Python training, React course, mobile app development course, UI UX design course, cloud computing training, DevOps course, machine learning course, career change tech, beginner coding, full-stack course, data science training, online tech school, programming bootcamp UK, tech skills training, coding for beginners, professional development tech, tech career training, software development course, digital skills academy, career in tech, HTML CSS course, SQL database course, API development course, Figma design, Next.js course, TypeScript course, LangChain AI, LLM integration, portfolio projects, tech certification UK, Swift Kotlin mobile, Flutter course, NoSQL databases, computer vision, NLP natural language processing, web developer career, junior developer training, hands-on projects, industry expert instructors, tech bootcamp online, remote learning tech, Tevuna Academy waitlist',
