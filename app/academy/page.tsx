                ...
                <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 border border-slate-200">
                  ...
                  <div className="mt-16 pt-12 border-t-2 border-slate-200">
                    <div className="text-center mb-8">
                      <span className="inline-block px-4 py-2 bg-primary-500/10 border border-primary-500/30 rounded-full text-primary-500 text-xs font-sans uppercase tracking-widest mb-4">
                        Join Waitlist
                      </span>
